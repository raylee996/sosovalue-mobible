...
const News = ({
  ...
  return (
    <div className="py-3 h-full">
      <div className="flex px-3 mb-2 justify-between border-0 border-b border-solid border-[#242424]">
      ...
      <div className="h-full overflow-y-auto max-h-[446px]">
            ...
            <div className="text-[#BBBBBB] text-xs font-light">
              <div className="text-[#CCCCCC] font-medium">
                ...
                >
                  ...
                  {/* { item.category != 'Insights' && <div className='line-clamp-2 text-[13px]  overflow-hidden'>{item.title}</div> }  
                { (item.category != 'Insights' && item.category != 'News') &&  <div className={`text-[#8D8D8D] w-full select-text my-2 line-clamp-4`} dangerouslySetInnerHTML={{__html:item.content}}></div>}
                { item.category == 'Insights' &&  <div className={`w-full select-text my-2 line-clamp-2`} dangerouslySetInnerHTML={{__html:item.content}}></div>}  */}
                </Link>
              </div>
              <div className="flex justify-between items-center mt-2">
                      ...
                      if (index < 3) {
                        return (
                          <div
                            ...
                            className="mr-2 text-xs cursor-pointer text-[#226DFF]"
                          >
                            {i.name.toUpperCase()}
                          </div>
                        );
                ...
                <div className="flex items-center">
                  {(item.category === 2 || item.category === 8) && (
                    <div className="text-xs text-[#8D8D8D] border-0">
                  ...
                  {/* <div className='text-xs text-[#8D8D8D] border-0'>{formatDate(item.realiseTime)}</div> */}
                  {item.author && (
                    <div
                  ...
                  {item.category !== 4 &&
                    ...
                    item.category !== 3 &&
                    item.category !== 7 && (
                      <div className="text-xs ml-4 text-[#8D8D8D] border-0 hidden 2xl:inline">
