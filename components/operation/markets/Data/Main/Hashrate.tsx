...
const MarketCap = ({status, classes} : Props) => {
    ...
    const getInitData = async () => {
        let init = {
            ...
            whatisDescription: '',
            whatisFormula: '',
            whatisMeaning: 'Bitcoin hashrate, also known as computing power, is the total amount of computational power that is being used to mine and process transactions on a Proof-of-Work blockchain, such as Bitcoin. The more hashing power in the network, the greater its security and its overall resistance to attack. ',
        }
