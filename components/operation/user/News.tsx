...
const News = ({
  ...
  return (
    <div className="py-3 h-full flex flex-col items-stretch">
      <div className="flex mb-2 px-3 justify-between border-0 border-b border-solid border-[#242424]">
      ...
      {!!articleList.length ? (
              ...
              <div className="text-[#BBBBBB] text-xs font-light">
                ...
                <div className="flex justify-between items-center mt-2">
                      ...
                      item.matchedCurrencies.map((i: any, index: number) => {
                        if (index < 3) {
                          return (
                            ...
                            <div
                              className="mr-2 text-xs underline underline-offset-1 cursor-pointer text-[#4589FF]"
                              key={index}
                  ...
                  <div className="flex">
                    ...
                    {/* <div className='text-xs text-[#8D8D8D]'>{formatDate(item.realiseTime)} </div> */}
                    {/* <div className='ml-4'>
        ...
        <div className="h-full px-6 flex flex-col items-center justify-center">
          ...
          <div className="text-sm text-[#C2C2C2] text-center mt-4">
            If you have any high-quality sources, feel free to Feedback and grab
            mystery gift boxes.
          </div>
        </div>
      )}
